...
const footerObject = [
    {
        ...
        sections: {
            socialMedias: [
                ...
                { name: "instagram", title: "اینستاگرام", icon: "icon", link: "https://" },
            ],
            contactUs: [
                { name: "address", title: "آدرس", icon: "icon", value: "تهران، شریعی", link: "" },
                { name: "phone", title: "تلفن", icon: "icon", value: "02100000000", link: "" },
                { name: "mobile", title: "تلفن همراه", icon: "icon", value: "09120000000", link: "" },
                { name: "email", title: "ایمیل", icon: "icon", value: "ehyadarman@gmail.com", link: "" },
            ],
            products: [
                {
